...
{
    public class CreadorMensajeDia : ICreadorMensaje
    {
        /// <summary>
        ...
        public CreadorMensajeDia(IObtenedorConfiguracionTiempo _obtenedorConfiguracionTiempo)
        {
        ...
        {
            return string.Format("{0} ocurrió hace {1} días", _cEvento, ObtenerValorTiempo(_iTiempoTranscurrido));
        }
        ...
        {
            return string.Format("{0} ocurrirá dentro de {1} días", _cEvento, ObtenerValorTiempo(_iTiempoPorTranscurrir));
        }

        /// <summary>
        /// Obtiene el valor del tiempo en días.
        /// </summary>
        /// <param name="_iTiempo">Cantidad de minutos.</param>
        /// <returns>Retorna un entero que contiene la cantidad de días.</returns>
        private int ObtenerValorTiempo(int _iTiempo)
        {
            return (int)(_iTiempo / ObtenedorConfiguracionTiempo.ObtenerMinutosDia());
        }
    }
}
